      ...
      <Container className="relative z-10 pt-32 pb-16 md:pb-20">
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-7">
            <FadeIn delay={0.1}>
              <p className="mb-6 text-xs font-medium uppercase tracking-[0.25em] text-mediterranean">
                Independent Branding &amp; Digital Studio
              </p>
            </FadeIn>

            <FadeIn delay={0.2}>
              <h1 className="font-serif text-4xl leading-[1.08] tracking-tight text-charcoal sm:text-5xl md:text-6xl lg:text-[4.25rem] text-balance">
                {siteConfig.tagline}
              </h1>
            </FadeIn>

            <FadeIn delay={0.35}>
              <p className="mt-8 max-w-xl text-base leading-[1.75] text-charcoal/70 md:text-lg">
          ...
          <FadeIn delay={0.3} direction="left" className="lg:col-span-5">
            ...
            >
              ...
              <div
                className="absolute -right-4 -bottom-4 -z-10 h-full w-full rounded-organic-lg bg-sand/60 md:-right-6 md:-bottom-6"
                aria-hidden="true"
              />
            </motion.div>
          </FadeIn>
